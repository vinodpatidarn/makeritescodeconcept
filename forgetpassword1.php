	...
	<div class="phppot-container">
		<div class="sign-up-container">
			<div class="signup-align">
				<form name="login" action="send_link.php" method="post"
				...
				<div class="row">
						<div class="inline-block">
							<div class="form-label">
								E-mail Address<span class="required error" id="username-info"></span>
							</div>
					...
					<div class="row">
						<input class="btn" style="background-color:red;color:white" type="submit" name="submit_email" id="forgot-btn"
